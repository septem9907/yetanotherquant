...
dax_results = backtest_universe(
    DAX_TICKERS, dax_prices, simple_ma_strategy, ma_days=200
)
...
dow_results = backtest_universe(
    DOW_TICKERS, dow_prices, simple_ma_strategy, ma_days=200
)
print("\nDOW30 MA200 results:")
print(dow_results)
...
dual_results = backtest_universe(
    DAX_TICKERS, dax_prices, dual_ma_crossover, short_days=38, long_days=200
)
print(dual_results)
...
ts = simulate_trading_system(
    n_trades=395, win_prob=0.64, ret_per_trade=0.003, n_sim=1_000, seed=42
)
